...
namespace DartsCore
{
	const int BULLVALUE = 50;	// This variable holds the bull value
	...
	int attemptHit(int,int=80);					// This tries to hit a number and returns the result, hit success is dependant on the success percentage - defaults to 80
