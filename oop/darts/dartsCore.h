...
namespace DartsCore
{
	...
	static int attemptHitPercentage(int,int);		// This tries to hit a number and returns the result, hit success is dependant on the success percentage
	...
	static const short DartsCore::score[2][21] = {{20, 1, 18, 4, 13, 6, 10, 15, 2, 17, 3, 19, 7, 16, 8, 11, 14, 9, 12, 5, 20},	//	This line holds the score at a given section
